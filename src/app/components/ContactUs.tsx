...
const ContactUs = () => {
  ...
  // Handle form submission (Mock function, replace with actual API integration)
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-start justify-between">
          ...
          <div className="grid grid-cols-2 gap-4 lg:w-1/2 mb-8 lg:mb-0">
            <Image
              src="/random_img1.jpg" // Update with actual image paths
              alt="Contact Image 1"
              width={300}
              height={300}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
                <input
                  ...
                  placeholder="Name"
                  className="w-full sm:w-1/2 border border-gray-300 rounded-md py-2 px-4 bg-pink-50 focus:outline-none focus:ring-2 focus:ring-pink-500"
                />
                <input
                  type="email"
                  value={email}
              ...
              <button
                type="submit"
                className="py-3 px-6 bg-pink-500 text-white rounded-lg shadow-lg hover:bg-pink-600 focus:outline-none transition-all duration-300"
              >
                Send it to us
              </button>
            </form>

      ...
      <div className="relative h-64 w-full">
        ...
        >
          <div className="text-pink-800 space-x-4">
            <a href={speaker.twitter} className="hover:text-pink-600"><FaTwitter className="inline-block text-2xl" /></a>
            <a href={speaker.linkedin} className="hover:text-pink-600"><FaLinkedin className="inline-block text-2xl" /></a>
            <a href={speaker.website} className="hover:text-pink-600"><FaGlobe className="inline-block text-2xl" /></a>
          </div>
        </motion.div>
      </div>
      <div className="p-6">
...
const KeynoteSpeakers = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-pink-100 to-pink-300 py-16">
